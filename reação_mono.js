...
function conservacao (atom1, atom2, E_lig){
  ...
  let r_b=p5.Vector.sub(centro_de_massa,b.pos);
  ...
  let L_b=p5.Vector.cross(p5.Vector.mult(b.velocity,b.m),r_b);  
  ...
  let E_cin1= p5.Vector.magSq(a.velocity)*a.m/2;
  let E_cin2= p5.Vector.magSq(b.velocity)*b.m/2;
